...
//       "Enveloppement au algues ou au chocolat",
//       "Masque éclat visage",
...
export default function Formules({formules}) {
  const sortedData = formules
  .slice()
    ...
    >
      <div className="max-w-[1124px] mx-auto md:pt-9">
        <div className="yellowDiv">
          <span className="yellowSpan">nos formules</span>
        </div>
      </div>
      <button
        onClick={prevHandler}
