...
const BathData = [
  {
    id: "1",
    name: "Salam",
    desc: "Ouvert 7j/7 exclusivement pour hommes.",
    img: "/bath1.jpeg",
  },
  {
    id: "2",
    name: "Istanbul",
    desc: "Ouvert 7j/7 pour femmes et enfants.",
    img: "/bath2.jpeg",
  },
  {
    id: "3",
    name: "Orient",
    desc: "Ouvert jeudi, samedi et dimanche, exclusivement pour les femmes.",
    img: "/bath3.jpeg",
  },
  {
    id: "4",
    name: "Individuel",
    desc: "Un espace privé pour les femmes uniquement, à la recherche  d'une expérience plus intime.",
    img: "/bath4.jpeg",
  },
];
    ...
    <div className="bg-primary h-[600px] md:h-[750px] relative" id="bains">
      <div className="max-w-[1124px] mx-auto md:pt-9">
        <div className="yellowDiv pt-[3.5rem] md:pb-9">
          <span className="yellowSpan">nos bains</span>
        </div>
        <button
          onClick={prevHandler}
