...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="text-light h-full flex flex-col md:flex-row justify-between max-w-[1124px] mx-auto px-8 xl:px-0">
        <div className="flex-1 ">
          <p className="md:text-[29px] text-[19px] md:leading-[40px] leading-[25px] font-bold md:text-justify text-justify ">
            Plongez dans l&apos;histoire du
            <span className="text-primary"> premier</span> hammam traditionnel
            distinctif fondé au Maroc en
            <span className="text-primary"> 1996.</span> Chez Hammam
            <span className="text-primary"> Ziani</span>, chaque visite est une
            invitation à un voyage{" "}
            <span className="text-primary"> authentique</span> et
            <span className="text-primary"> traditionnel</span>, bénéficiant
            d&apos;un service personnalisé et d&apos;un personnel professionnel
            aux petits soins.
          </p>
        </div>
          ...
          <div className="w-[18rem] h-[20rem] md:h-[23rem] md:w-[20rem] flex flex-col justify-between bg-light relative">
            ...
            <div className="text-blue flex gap-3 flex-col text-center items-center justify-center mt-[3rem] md:mt-[4rem]">
              ...
              <p className="text-[25px] md:text-[27px] font-semibold leading-[28px] md:leading-[35px]">
                Bains Traditionnels <br /> au Maroc
              </p>
            </div>
            {/* Image */}
        ...
        <div className="absolute bottom-[2.5rem] left-[2rem]">
          <div className="w-[6.5rem] h-[8.5rem] bg-[#19a780] relative rounded-t-full">
            <TripAdvisor title="Certificat d'excellence" />
          </div>
        </div>
      ...
      <Link
        href={"/en"}
        className="absolute top-[2rem] md:-top-[2.3rem] left-[2rem] text-light border rounded-full"
      >
        <Image src={"/en.png"} alt="" width={30} height={30} />
      </Link>
    </div>
  );
}
