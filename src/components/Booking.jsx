        ...
        <div className="flex-1 flex items-center justify-center md:justify-end h-full">
          ...
          >
            <div className="flex h-full gap-1 md:gap-2 flex-col items-center justify-center bg-blue border border-primary rounded-t-[14rem] pt-[4rem] md:pt-[5rem]">
              ...
              />
              <input
                className="input before:content-['Date'] lg:before:content-[''] before:pr-4 before:text-gray-400 "
                type="date"
                name="date"
                value={formData.date}
                onChange={handleChange}
              />
              <input
                className="input before:content-['Heure'] lg:before:content-[''] before:pr-4 before:text-gray-400"
                type="time"
                name="heure"
